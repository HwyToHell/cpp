...
#define VIBE_COLOR_BACKGROUND   0 /*!< Default label for background pixels */
#define VIBE_COLOR_FOREGROUND 255 /*!< Default label for foreground pixels. Note that some authors chose any value different from 0 instead */
